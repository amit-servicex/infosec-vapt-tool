...
def main():
    ...
    f = workdir / "content.txt"; f.write_text("[stub] content discovery\n", encoding="utf-8")
    print(json.dumps({"status":"ok","artifacts":[{"path":str(f),"description":"content discovery","content_type":"text/plain"}],"findings":[],"stats":{}}))
